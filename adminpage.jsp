    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <p class="infopost">&nbsp;</p>
          <form id="form1" name="form1" method="post" action="AdminBooking">
            <div align="center">
              <table width="442" height="418" border="0">
                
                <tr>
                  <td width="212"><div align="center"><span class="style1">From</span></div></td>
                  <td width="214"><label>
                    <div align="center">
                      <input name="from1" type="text" id="from1" />
                      </div>
                  </label></td>
                </tr>
                <tr>
                  <td><div align="center"><span class="style1">To</span></div></td>
                  <td><label>
                    <div align="center">
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="adminlogin.jsp">Logout</a><a href="userlogin.jsp"></a></li>
            </ul>
        </div>
